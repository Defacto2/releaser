...
var initialisms = List{
	...
	"inc-documentation-division": {
		"IDD",
		"International Network of Crackers Documentation Division",
	},
	...
	"public-enemy":                            {"PE"},
	"public-enemy*red-sector-inc": {"PE",
		"PE/RSI", "Public Enemy, Tristar & Red Sector Inc, Defjam, The Dream Team",
		"Public Enemy, Red Sector Inc, Tristar, Defjam"},
	"quartex":                {"QTX"},
	quick:                    {"QUICK"},
